"""
╔══════════════════════════════════════════════════════════════════════════════╗
║  ⚠️  CORTEX MODEL SERVER - 重要研发规则  ⚠️                                    ║
╠══════════════════════════════════════════════════════════════════════════════╣
║                                                                              ║
║  🚫 绝对不要随意重启 Cortex！加载模型需要 3-5 分钟！                            ║
║                                                                              ║
║  高效研发流程:                                                                ║
║  1. Cortex (9000): Pod 启动时加载一次，之后保持运行，不要动                     ║
║  2. Logic Server (8000): 代码改动后只重启这个（秒级）                          ║
║  3. Cortex 代码改动: 先 mock 测试，全部定型后再统一更新                         ║
║                                                                              ║
║  ❌ 错误: 改了一行代码就重启 Cortex                                            ║
║  ✅ 正确: 用已运行的 Cortex 测试，最后统一更新                                  ║
║                                                                              ║
╚══════════════════════════════════════════════════════════════════════════════╝
"""
